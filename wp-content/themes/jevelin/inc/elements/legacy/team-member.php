...
class vcj_team_member extends WPBakeryShortCode {
  ...
  array (
    ...
    array (
      'param_name' => 'tiktok',
      'heading' => 'Tiktok',
      'description' => 'Enter Tiktok URL or leave it blank',
      'value' => '',
      'type' => 'textfield',
      'class' => '',
      'std' => '',
    ...
    public function _html( $atts, $content ) {
        ...
        include get_theme_file_path( '/framework-customizations/extensions/shortcodes/shortcodes/team-member/views/view.php' );
        include get_theme_file_path( '/framework-customizations/extensions/shortcodes/shortcodes/team-member/static.php' );
