...
class vcj_pie_chart extends WPBakeryShortCode {
  ...
  array (
    ...
    public function _html( $atts, $content ) {
        ...
        include get_theme_file_path( '/framework-customizations/extensions/shortcodes/shortcodes/pie-chart/views/view.php' );
        include get_theme_file_path( '/framework-customizations/extensions/shortcodes/shortcodes/pie-chart/static.php' );
