...
class vcj_icon_box extends WPBakeryShortCode {
  ...
  array (
    ...
    array (
      ...
      'heading' => 'Box Alignment',
      'description' => 'Choose box alignment',
      'value' => 
      array (
        'Default' => 'default',
        'Left' => 'left',
    ...
    public function _html( $atts, $content ) {
        ...
        include get_theme_file_path( '/framework-customizations/extensions/shortcodes/shortcodes/icon-box/views/view.php' );
        include get_theme_file_path( '/framework-customizations/extensions/shortcodes/shortcodes/icon-box/static.php' );
