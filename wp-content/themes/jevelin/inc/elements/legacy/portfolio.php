...
class vcj_portfolio extends WPBakeryShortCode {
  ...
  array (
    ...
    array (
      ...
      'heading' => 'Use Custom Links',
      'description' => 'Enable or disable option to use custom link redirects without opening the page',
      'value' => 
      array (
        'Off' => false,
        'On' => true,
    ...
    public function _html( $atts, $content ) {
        ...
        include get_theme_file_path( '/framework-customizations/extensions/shortcodes/shortcodes/portfolio/views/view.php' );
        include get_theme_file_path( '/framework-customizations/extensions/shortcodes/shortcodes/portfolio/static.php' );
