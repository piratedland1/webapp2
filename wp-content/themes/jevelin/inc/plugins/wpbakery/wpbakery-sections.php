...
function custom_post_type() {
	...
	// Titlebars
    $labels = array(
		'name'                  => _x( 'Titlebars', 'Post Type General Name', 'jevelin' ),
		'singular_name'         => _x( 'Titlebar', 'Post Type Singular Name', 'jevelin' ),
		'menu_name'             => __( 'Titlebars', 'jevelin' ),
		'name_admin_bar'        => __( 'Titlebar', 'jevelin' ),
		'archives'              => __( 'Item Archives', 'jevelin' ),
		'attributes'            => __( 'Item Attributes', 'jevelin' ),
		'parent_item_colon'     => __( 'Parent Item:', 'jevelin' ),
		'all_items'             => __( 'All Items', 'jevelin' ),
	...
	$args = array(
		'label'                 => __( 'Titlebar', 'jevelin' ),
		'description'           => __( 'Build your titlebar with WPbakery page builder', 'jevelin' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'revisions' ),
		//'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
	...
	register_post_type( 'shufflehound_titleb', $args );
