...
<div id="icon-<?php echo esc_attr( $id ); ?>" class="sh-icon <?php echo $inline_element; ?> sh-icon-<?php echo esc_attr( $alignment ); ?> sh-icon-mobile-<?php echo esc_attr( $alignment_mobile ); ?><?php echo esc_attr( $animated ); ?>" <?php echo wp_kses_post( $animated_speed ) . wp_kses_post( $animated_delay ); ?>>
	<?php if( $url ) : ?>
