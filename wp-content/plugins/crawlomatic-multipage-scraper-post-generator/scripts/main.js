"use strict"; 
var initial = '';
    function mainChangedUpdate()
    {
        if(jQuery("#auto_update_posts option:selected").val() === 'No') 
        {      
            jQuery(".hideUpdate").hide();
        }
        else
        {
            jQuery(".hideUpdate").show();
        }
    }
    function mainChanged()
    {
        ...
        if(jQuery("#spin_text option:selected").val() === 'best' || jQuery("#spin_text option:selected").val() === 'wordai' || jQuery("#spin_text option:selected").val() === 'spinrewriter' || jQuery("#spin_text option:selected").val() === 'turkcespin' || jQuery("#spin_text option:selected").val() === 'spinnerchief') 
        {      
        ...
        if(jQuery("#spin_text option:selected").val() === 'tldr' || jQuery("#spin_text option:selected").val() === 'best' || jQuery("#spin_text option:selected").val() === 'wordai' || jQuery("#spin_text option:selected").val() === 'spinrewriter' || jQuery("#spin_text option:selected").val() === 'turkcespin' || jQuery("#spin_text option:selected").val() === 'spinnerchief') 
        {      
...
if (mycustommainsettings.best_user == '' || mycustommainsettings.best_password == '') 
{
        ...
        if(jQuery("#spin_text option:selected").val() === 'turkcespin') 
        {      
            jQuery("#turkcespin").show();
        }
        else
        {
            jQuery("#turkcespin").hide();
        }
}
else
{
