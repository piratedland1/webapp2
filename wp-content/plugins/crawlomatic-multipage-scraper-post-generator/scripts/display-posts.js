...
registerBlockType( 'crawlomatic-multipage-scraper-post-generator/crawlomatic-display', {
    title: 'Crawlomatic Display Posts',
    icon: 'admin-page',
    category: 'embed',
    attributes: {
        ruletype : {
    ...
    keywords: ['display', 'posts', 'crawlomatic'],
    edit: (function( props ) {
